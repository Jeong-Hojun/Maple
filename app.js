(function bootstrapApp() {
  ...
  async function analyzeWithGemini(dataUrl, apiKey) {
    ...
    var prompt = [
      ...
      "발판 배경 색상으로 비료값을 추론할 수 있습니다 (캐릭터·이펙트에 가려진 칸도 색상으로 판단):",
      "  - 연분홍/살구색 배경 = +100",
      "  - 청록/민트색 배경 = +300",
      "  - 보라/연보라색 배경 = +400",
      "  - 노란색/황금색 배경 = +600",
      ...
      "- 황금 벌 있는 발판 → 비료 값 2배",
      "  ※ 황금 벌: 발판 위에 노란색/황금색 벌 아이콘이 겹쳐 있고, 작은 숫자(예: '+1')가 함께 표시됨.",
      "  ※ 황금 벌이 있으면 해당 발판 비료값 × 2. 예: +400 발판에 황금 벌 → fertilizer:800",
      "- 신비한 벌 있는 발판 → 비료 값 3배",
      "  ※ 신비한 벌: 발판 위에 보라색/파란색 벌 아이콘, 작은 숫자(예: '+2') 표시됨.",
      "  ※ 신비한 벌이 있으면 해당 발판 비료값 × 3.",
      "- 독 호문스큘러 있는 발판 → 비료 값 절반",
      "⚠️ 벌/몬스터 아이콘이 발판 위에 겹쳐 있으면 반드시 배율을 적용한 값을 fertilizer에 기록하세요.",
      "",
      "=== 응답 ===",
