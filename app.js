(function bootstrapApp() {
  ...
  async function analyzeWithGemini(dataUrl, apiKey) {
    ...
    var prompt = [
      ...
      "③ 벌 아이콘이 발판 위에 겹쳐 있으면 배율 적용:",
      "   - 황금 벌(노란 벌 아이콘): 읽은 숫자 × 2  예) +400 + 황금벌 → fertilizer:800",
      "   - 신비한 벌(보라 벌 아이콘): 읽은 숫자 × 3  예) +400 + 신비한벌 → fertilizer:1200",
      "④ 독 호문스큘러(몬스터): 표시된 숫자가 이미 절반으로 줄어든 최종값 → 그대로 읽는다",
      "⚠️ 벌이 있으면 반드시 배율 계산을 하세요. 벌 아이콘이 있는데 기본 숫자만 쓰면 틀립니다.",
